        <footer
            class="bg-gray-50 dark:bg-gradient-to-r dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-t border-gray-200 dark:border-gray-700/50 transition-all duration-300 ease-in-out"
                        ...
                        <div class="flex items-center space-x-4">
                            @if ($website_settings->show_imprint)
                                <a target="_blank" href="{{ route('terms', 'imprint') }}"
                                    class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium transition-colors duration-200">
                                    {{ __('Imprint') }}
                                </a>
                            @endif
