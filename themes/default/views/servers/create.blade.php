                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @if ($location_description_enabled)
                                    <i x-show="locationDescription != null" x-bind:data-tippy-content="locationDescription"
                                        data-tippy-interactive="true" class="fas fa-info-circle"></i>
                                @endif
                            ...
                            <div class="form-group">
                                <label for="billing_priority">
                                    {{ __('Billing Priority') }}
                                    <i data-tippy-content="{{ __('Defines the priority for server billing. If not provided, the value of selected product will be used.') }}"
                                        data-tippy-interactive="true" class="fas fa-info-circle"></i>
                                </label>
                            ...
                            <div class="text-left form-group">
                              <div class="d-flex justify-content-between">
                                ...
                                ${variable.description
                                  ? `
                                <span>
                                  <i title="${variable.description}" class="fas fa-info-circle"></i>
                                </span>
                              `
                                  : ''
                                }
