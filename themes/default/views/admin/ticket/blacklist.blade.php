                        ...
                        <div class="p-6">
                            <form action="{{route('admin.ticket.blacklist.add')}}" method="POST" class="ticket-form">
                                ...
                                <div class="flex justify-end">
                                    <button type="submit" class="ticket-once inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:hover:bg-blue-500">
                                        {{__('Submit')}}
                                    </button>
                                </div>
                            </form>
