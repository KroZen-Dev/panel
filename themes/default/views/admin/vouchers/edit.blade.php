...
@section('content')
    <div class="mb-6 flex flex-col justify-between gap-y-4 sm:flex-row sm:items-center">
        ...
        <ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li>/</li>
            <li>
                <a href="{{ route('admin.vouchers.index') }}" class="hover:text-blue-600 dark:hover:text-blue-400">{{ __('Vouchers') }}</a>
            </li>
            <li>/</li>
            <li>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800">
                        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center dark:border-gray-700">
                            <h5 class="text-lg font-medium text-gray-800 dark:text-white">
                                <i class="fas fa-money-check-alt mr-2 text-gray-500 dark:text-gray-400"></i>{{ __('Voucher details') }}
                            </h5>
                        </div>
                        <div class="p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex rounded-md shadow-sm">
                                        <input value="{{ $voucher->code }}" placeholder="SUMMER" id="code" name="code" type="text"
                                               class="block w-full rounded-l-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('code') border-red-500 @enderror"
                                               required="required">
                                        <button class="inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-blue-500 text-white sm:text-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex rounded-md shadow-sm">
                                        <input value="{{ $voucher->uses }}" id="uses" min="1" max="2147483647" name="uses" type="number"
                                               class="block w-full rounded-l-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('uses') border-red-500 @enderror"
                                               required="required">
                                        <button class="inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-blue-500 text-white sm:text-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600"
                                    ...
                                    <div class="relative" id="expires_at" data-target-input="nearest">
                                        <div class="flex rounded-md shadow-sm">
                                            <input value="{{ $voucher->expires_at ? $voucher->expires_at->format('d-m-Y H:i:s') : '' }}"
                                                   ...
                                                   class="block w-full rounded-l-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm datetimepicker-input dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('expires_at') border-red-500 @enderror"
