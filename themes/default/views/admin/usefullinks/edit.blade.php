...
@section('content')
    <div class="mb-6 flex flex-col justify-between gap-y-4 sm:flex-row sm:items-center">
        ...
        <ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li>/</li>
            <li>
                <a href="{{ route('admin.usefullinks.index') }}" class="hover:text-accent-600 dark:hover:text-accent-400">{{ __('Useful Links') }}</a>
            </li>
            <li>/</li>
            <li>
                        ...
                        <div class="p-6">
                            <form action="{{ route('admin.usefullinks.update', $link->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{ $link->icon }}" id="icon" name="icon" type="text"
