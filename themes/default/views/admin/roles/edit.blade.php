        ...
        <div class="mb-6 flex flex-col justify-between gap-y-4 sm:flex-row sm:items-center">
            ...
            <div class="col-sm-6">
                <ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 justify-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.settings.index') }}" class="hover:text-blue-600 dark:hover:text-blue-400">{{ __('Dashboard') }}</a></li>
                    <li>/</li>
                    ...
                    <div class="col-12 p-0">
                        <form method="post" action="{{isset($role) ? route('admin.roles.update', $role->id) : route('admin.roles.store')}}">
                            ...
                            <div class="mt-6 flex justify-end">
                                <button name="submit" type="submit" class="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:hover:bg-blue-500">
                                    {{__('Submit')}}
                                </button>
                            </div>
                        </form>
