                    ...
                    <div class="col-span-1">
                        ...
                        @if ($product->servers()->count() > 0)
                            <div class="mb-4 border-l-4 border-red-500 bg-red-100 p-4 text-red-700 dark:bg-red-900/50 dark:text-red-300">
                                <h4 class="font-bold">{{ __('Editing the resource options will not automatically update the servers on pterodactyls side!') }}</h4>
                            </div>
                        @endif
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-4 flex flex-row-reverse">
                                    <div class="flex items-center">
                                        <input type="checkbox" @if ($product->disabled) checked @endif name="disabled" id="switch1"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{ $product->name }}" id="name" name="name"
                                           type="text" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('name') border-red-500 @enderror"
                                           required="required">
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" type="text"
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('description') border-red-500 @enderror" required="required">{{ $product->description }}</textarea>
                                    @error('description')
                                        <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input value="{{ $product->cpu }}" id="cpu" name="cpu" type="number"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('cpu') border-red-500 @enderror" required="required">
                                        @error('cpu')
                                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        <input value="{{ $product->disk }}" id="disk" name="disk"
                                               type="number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('disk') border-red-500 @enderror"
                                               required="required">
                                        @error('disk')
                                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input value="{{ $product->memory }}" id="memory" name="memory"
                                               type="number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('memory') border-red-500 @enderror"
                                               required="required">
                                        @error('memory')
                                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ $product->io }}" id="io" name="io"
                                               type="number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('io') border-red-500 @enderror"
                                               required="required">
                                        @error('io')
                                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input value="{{ $product->swap }}" id="swap" name="swap"
                                               type="number" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 @error('swap') border-red-500 @enderror"
                                               required="required">
                                        @error('swap')
                                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="serverlimit" class="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">
                                            {{ __('Serverlimit') }}
                                            <i class="fas fa-info-circle ml-1 text-gray-400 cursor-help dark:text-gray-500" data-toggle="popover" data-trigger="hover" data-content="{{ __('The maximum amount of Servers that can be created with this Product per User. 0 = unlimited') }}"></i>
                                        </label>
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800">
                            ...
                            <div class="p-6">
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('No Eggs or Nodes shown?') }} <a href="{{ route('admin.overview.sync') }}" class="text-blue-600 hover:underline dark:text-blue-400">{{ __('Sync now') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
